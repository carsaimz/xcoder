...
### Added
- Active indent guide (roadmap v1.5.x item 2) — VSCode-style opt-in highlight
- V1.5.2 — chat strip rework, real brand logos, toggle/clipboard/terminal fixes, AI errors i18n

### Fixed
- Release dispatch tolerates re-running the current version — the forward-only check now skips when INPUT_VERSION equals the repo version (unblocks manual re-release)
