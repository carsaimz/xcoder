...
function backupRestore() {
	...
	async function backup() {
		...
		try {
			...
			const backupFilename = `XCoder_backup_${timestamp}.backup`;
			...
			for (const id of backup.installedPlugins) {
				...
				try {
					if (
						...
						// XCoder: remote registry is offline - only plugins backed up
						// from a local source can be restored automatically.
						restoreResults.plugins.skipped.push({
							id: pluginName,
