package com.xcoder.crashhandler;
...
public class CrashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fullReport = "XCoder Crash Report\n" +
                "==================\n" +
        ...
        titleView.setText("XCoder Crashed");
        ...
        descView.setText("An unrecoverable exception occurred in XCoder's native system. The application details and exception logs have been recorded below.");
        ...
        TextView btnRestart = createButton("Restart XCoder", colorButtonPrimaryText, colorButtonPrimaryBg, false);
        ...
        btnCopy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ClipData clip = ClipData.newPlainText("XCoder Crash Log", fullReport);
    ...
    private void loadThemeColors() {
        ...
        try {
            prefs = getApplicationContext()
                    .getSharedPreferences("xcoder_theme", Context.MODE_PRIVATE);
