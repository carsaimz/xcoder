...
declare const xcoder: {
  webview: XCoderWebViewAPI;
  [key: string]: unknown;
};
...
interface EditorManager {
  ...
  activeFile?: XCoderFile;
  getLspMetadata?: (file: XCoderFile) => LspFileMetadata | null;
}
...
interface XCoderWebViewAPI {
  create(options?: WebViewOptions): Promise<XCoderWebView>;
}
