...
import type { XCoderApi, FileMetadata } from "./types";
...
interface EditorManagerWithLsp {
	...
	getLspMetadata?: (file: XCoderFile) => FileMetadata | null;
}

function getActiveMetadata(
	manager: EditorManagerWithLsp | undefined,
	file: XCoderFile | undefined,
...
export function registerLspFormatter(xcoder: XCoderApi): void {
