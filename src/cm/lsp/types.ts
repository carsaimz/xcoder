...
export interface XCoderClientConfig {
...
export interface LspServerManifest {
	...
	clientConfig?: Record<string, unknown> | XCoderClientConfig;
...
export interface LspServerDefinition {
	...
	initializationOptions?: Record<string, unknown>;
	workspaceConfiguration?: Record<string, unknown>;
	clientConfig?: XCoderClientConfig;
	startupTimeout?: number;
	capabilityOverrides?: Record<string, unknown>;
	rootUri?:
		| ((uri: string, context: RootUriContext) => MaybePromise<string | null>)
...
// Extend the LSPClient with XCoder-specific properties
