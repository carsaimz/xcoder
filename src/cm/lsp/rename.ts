...
import type XCoderWorkspace from "./workspace";
...
async function doRename(
	...
	const workspace = plugin.client.workspace as XCoderWorkspace;
	let filesChanged = 0;
...
export const xcoderRenameKeymap: readonly KeyBinding[] = [
	{ key: "F2", run: renameSymbol, preventDefault: true },
];

export const xcoderRenameExtension = () => keymap.of([...xcoderRenameKeymap]);
