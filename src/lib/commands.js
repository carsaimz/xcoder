...
export default {
        ...
        async "ai-chat"() {
                const { openAiChat } = await import(
                        /* webpackChunkName: "aiActions" */ "lib/ai/actions"
                );
                await openAiChat();
        },
        async "ai-explain"() {
                const { runAiAction } = await import(
                        /* webpackChunkName: "aiActions" */ "lib/ai/actions"
                );
        ...
        async "ai-refactor"() {
                ...
                await runAiAction("refactor");
        },
        async "ai-comments"() {
                const { runAiAction } = await import(
                        /* webpackChunkName: "aiActions" */ "lib/ai/actions"
                );
                await runAiAction("comments");
        },
        async "ai-ask"() {
                const { runAiAction } = await import(
                        /* webpackChunkName: "aiActions" */ "lib/ai/actions"
                );
                await runAiAction("custom");
        },
        async files() {
        ...
        async format(selectIfNull) {
                ...
                const didFormat = await xcoder.format(selectIfNull);
                if (didFormat) {
