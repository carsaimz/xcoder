...
async function EditorManager($header, $body) {
	...
	const UNTITLED_URI_PREFIX = "untitled://xcoder/";
	...
	const cmOptionSpecs = [
		...
		{
			keys: ["indentGuides", "activeIndentGuide"],
	...
	if (typeof document !== "undefined") {
		...
		const diagnosticsListenerKey = "__xcoderDiagnosticsListener";
