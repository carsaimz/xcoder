...
export default async function loadPlugin(pluginId, justInstalled = false) {
	...
	// because once the new script loads, it calls xcoder.setPluginUnmount(id, newDestroy)
	...
	return new Promise((resolve, reject) => {
		...
		$script.onload = async () => {
			...
			try {
				...
				await xcoder.initPlugin(pluginId, baseUrl, $page, {
