...
// Bundled fonts only — no remote font downloads. Users can add custom fonts
// locally via the font manager (fonts.addCustom).
add(
        "Cascadia Code",
        `@font-face {
  font-family: 'Cascadia Code';
  src: local('Cascadia Code'), local('CascadiaCode'), local('Cascadia Mono');
  font-weight: 300 700;
  font-style: normal;
}`,
);
