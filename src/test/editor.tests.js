...
export async function runCodeMirrorTests(writeOutput) {
	...
	runner.test("XCoder exposes shared CodeMirror modules", async (test) => {
		const codemirror = xcoder.require("codemirror");
		const language = xcoder.require("@codemirror/language");
		const lezer = xcoder.require("@lezer/highlight");
		const state = xcoder.require("@codemirror/state");
		const view = xcoder.require("@codemirror/view");
	...
	runner.test(
		"XCoder exposes the static CodeMirror highlighter",
		async (test) => {
			const codeHighlight = xcoder.require("codeHighlight");
			const codemirror = xcoder.require("codemirror");
